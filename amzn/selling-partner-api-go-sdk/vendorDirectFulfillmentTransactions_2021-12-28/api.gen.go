...
func (c *Client) GetTransactionStatus(ctx context.Context, transactionId string) (*http.Response, error) {
	req, err := NewGetTransactionStatusRequest(c.Endpoint, transactionId)
	if err != nil {
		return nil, err
	}
...
func NewGetTransactionStatusRequest(endpoint string, transactionId string) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/vendor/directFulfillment/transactions/2021-12-28/transactions/%s", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
