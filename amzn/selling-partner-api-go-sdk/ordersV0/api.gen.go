// Package shipment provides primitives to interact the openapi HTTP API.
//
...
type ClientInterface interface {
	...
	// UpdateVerificationStatus request  with any body
	...
	// UpdateShipmentStatus request  with any body
...
func (c *Client) GetOrderRegulatedInfo(ctx context.Context, orderId string) (*http.Response, error) {
	req, err := NewGetOrderRegulatedInfoRequest(c.Endpoint, orderId)
	if err != nil {
		return nil, err
	}
...
func (c *Client) UpdateVerificationStatusWithBody(ctx context.Context, orderId string, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewUpdateVerificationStatusRequestWithBody(c.Endpoint, orderId, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) UpdateVerificationStatus(ctx context.Context, orderId string, body UpdateVerificationStatusJSONRequestBody) (*http.Response, error) {
	req, err := NewUpdateVerificationStatusRequest(c.Endpoint, orderId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateShipmentStatusWithBody(ctx context.Context, orderId string, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewUpdateShipmentStatusRequestWithBody(c.Endpoint, orderId, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) UpdateShipmentStatus(ctx context.Context, orderId string, body UpdateShipmentStatusJSONRequestBody) (*http.Response, error) {
	req, err := NewUpdateShipmentStatusRequest(c.Endpoint, orderId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetOrderRegulatedInfoRequest(endpoint string, orderId string) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/orders/v0/orders/%s/regulatedInfo", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewUpdateVerificationStatusRequest(endpoint string, orderId string, body UpdateVerificationStatusJSONRequestBody) (*http.Request, error) {
	...
	return NewUpdateVerificationStatusRequestWithBody(endpoint, orderId, "application/json", bodyReader)
}

// NewUpdateVerificationStatusRequestWithBody generates requests for UpdateVerificationStatus with any type of body
func NewUpdateVerificationStatusRequestWithBody(endpoint string, orderId string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewUpdateShipmentStatusRequest(endpoint string, orderId string, body UpdateShipmentStatusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateShipmentStatusRequestWithBody(endpoint, orderId, "application/json", bodyReader)
}

// NewUpdateShipmentStatusRequestWithBody generates requests for UpdateShipmentStatus with any type of body
func NewUpdateShipmentStatusRequestWithBody(endpoint string, orderId string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/orders/v0/orders/%s/shipment", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
// GetOrderRegulatedInfoWithResponse request returning *GetOrderRegulatedInfoResponse
...
// UpdateVerificationStatusWithBodyWithResponse request with arbitrary body returning *UpdateVerificationStatusResponse
