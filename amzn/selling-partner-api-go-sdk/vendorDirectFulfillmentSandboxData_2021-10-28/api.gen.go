...
package vendorDFSandboxtransactionstatus
...
type ClientInterface interface {
	// GenerateOrderScenarios request  with any body
...
func (c *Client) GenerateOrderScenariosWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewGenerateOrderScenariosRequestWithBody(c.Endpoint, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GenerateOrderScenarios(ctx context.Context, body GenerateOrderScenariosJSONRequestBody) (*http.Response, error) {
	req, err := NewGenerateOrderScenariosRequest(c.Endpoint, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetOrderScenarios(ctx context.Context, transactionId string) (*http.Response, error) {
	req, err := NewGetOrderScenariosRequest(c.Endpoint, transactionId)
	if err != nil {
		return nil, err
	}
...
func NewGenerateOrderScenariosRequest(endpoint string, body GenerateOrderScenariosJSONRequestBody) (*http.Request, error) {
	...
	return NewGenerateOrderScenariosRequestWithBody(endpoint, "application/json", bodyReader)
}

// NewGenerateOrderScenariosRequestWithBody generates requests for GenerateOrderScenarios with any type of body
func NewGenerateOrderScenariosRequestWithBody(endpoint string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/vendor/directFulfillment/sandbox/2021-10-28/orders")
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewGetOrderScenariosRequest(endpoint string, transactionId string) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/vendor/directFulfillment/sandbox/2021-10-28/transactions/%s", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
// GenerateOrderScenariosWithBodyWithResponse request with arbitrary body returning *GenerateOrderScenariosResponse
...
// GetOrderScenariosWithResponse request returning *GetOrderScenariosResponse
