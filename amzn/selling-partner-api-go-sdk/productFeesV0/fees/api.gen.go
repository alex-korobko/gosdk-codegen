...
type ClientInterface interface {
	// GetMyFeesEstimates request  with any body
...
func (c *Client) GetMyFeesEstimatesWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewGetMyFeesEstimatesRequestWithBody(c.Endpoint, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetMyFeesEstimates(ctx context.Context, body GetMyFeesEstimatesJSONRequestBody) (*http.Response, error) {
	req, err := NewGetMyFeesEstimatesRequest(c.Endpoint, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetMyFeesEstimatesRequest(endpoint string, body GetMyFeesEstimatesJSONRequestBody) (*http.Request, error) {
	...
	return NewGetMyFeesEstimatesRequestWithBody(endpoint, "application/json", bodyReader)
}

// NewGetMyFeesEstimatesRequestWithBody generates requests for GetMyFeesEstimates with any type of body
func NewGetMyFeesEstimatesRequestWithBody(endpoint string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/products/fees/v0/feesEstimate")
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
// GetMyFeesEstimatesWithBodyWithResponse request with arbitrary body returning *GetMyFeesEstimatesResponse
